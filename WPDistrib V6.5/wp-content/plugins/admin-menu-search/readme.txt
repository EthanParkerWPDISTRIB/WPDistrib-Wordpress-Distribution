...
Tags: admin menu search, search admin menu, admin menu, admin search, menu, search, filter, find, admin menu filter
...
Adds a search box filter to the top of the WordPress Admin Menu. Admin Menu Search allows you to easily locate menu items on sites with lots of menu items. 
